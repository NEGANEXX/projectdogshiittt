...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen w-full bg-[var(--color-bg)] flex items-center justify-center p-4">
      <div className="card w-[80%] lg:w-[70%] md:w-[55%] flex justify-between h-[600px] bg-[var(--color-surface)] rounded-lg shadow-xl border border-[var(--color-border)]">
        <div
        ...
        >
          ...
          <div className="form-container sign-in-container h-full z-10 relative">
            <form className="text-center py-10 md:py-20 grid gap-2 h-full" onSubmit={handleSubmit}>
              ...
              <a href="#" className="font-light text-sm md:text-md text-[var(--color-text-primary)] hover:text-[var(--color-text-primary)]/80 transition-colors">
        ...
        <div className="hidden lg:block w-1/2 right h-full overflow-hidden">
          <Image
            src="https://images.unsplash.com/photo-1510952267577-fc96d5ca660a?w=1000&auto=format&fit=crop&q=80&ixlib=rb-4.1.0"
            width={1000}
            height={1000}
            priority
            alt="Morocco travel"
